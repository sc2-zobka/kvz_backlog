...
class SaleOrde(models.Model):
	...
	project_line_ids = fields.Many2many('project.project','project_project_line_ids','order_id','project_id', string="Projects")
	...
	def _compute_tasks_ids(self):
		for order in self:
			...
			domain = [('project_id', '!=', False),'|',('sale_line_id', 'in', line_ids),('sale_order_id', '=', order.id),]
